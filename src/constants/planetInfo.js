const planetInfo = {
	mercury: {
		imgInternal: './assets/planet-mercury-internal.svg',
		info: [
			{
				title: 'OVERVIEW',
	...
	venus: {
		imgInternal: './assets/planet-venus-internal.svg',
		info: [
			{
				title: 'OVERVIEW',
	...
	earth: {
		imgInternal: './assets/planet-earth-internal.svg',
		info: [
			{
				title: 'OVERVIEW',
	...
	mars: {
		imgInternal: './assets/planet-mars-internal.svg',
		info: [
			{
				title: 'OVERVIEW',
	...
	jupiter: {
		imgInternal: './assets/planet-jupiter-internal.svg',
		info: [
			{
				title: 'OVERVIEW',
	...
	saturn: {
		imgInternal: './assets/planet-saturn-internal.svg',
		info: [
			{
				title: 'OVERVIEW',
	...
	uranus: {
		imgInternal: './assets/planet-uranus-internal.svg',
		info: [
			{
				title: 'OVERVIEW',
	...
	neptune: {
		imgInternal: './assets/planet-neptune-internal.svg',
		info: [
			{
				title: 'OVERVIEW',
